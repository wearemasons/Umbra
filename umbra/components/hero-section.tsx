                  ...
                  <div className="mx-auto max-w-sm">
                    ...
                    <Unauthenticated>
                      <Button
                        ...
                        className="w-full bg-primary/90 backdrop-blur-sm hover:bg-primary text-primary-foreground shadow-lg"
                      >
                        <Link href="/sign-up" className="flex flex-row">
                          <span className="mr-2">Get Started</span>
                          <SendHorizonal className="size-5" strokeWidth={2} />
                        </Link>
                      </Button>
        ...
        <div className="space-y-3">
          <div className="space-y-1">
            <div className="space-x-1">
              <span className="text-foreground align-baseline text-xl font-medium">12,847</span>
              <span className="text-muted-foreground text-xs">Papers indexed</span>
            </div>
          ...
          <div className="space-y-1">
            <div className="space-x-1">
              <span className="text-foreground align-baseline text-xl font-medium">607</span>
              <span className="text-muted-foreground text-xs">Papers indexed</span>
            </div>
