                    ...
                    <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-32 lg:pt-48">
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            ...
                            <TextEffect
                                ...
                                Umbra is a research knowledge management platform that collects, summarizes, and organizes scientific papers into a structured database. Each research paper is automatically processed using AI models to generate concise summaries, highlight key insights, and link related works together.
                            </TextEffect>
                                    ...
                                    <div className="bg-background has-[input:focus]:ring-muted relative grid grid-cols-[1fr_auto] items-center rounded-[calc(var(--radius)+0.5rem)] border pr-2 shadow shadow-zinc-950/5 has-[input:focus]:ring-2">
                                        ...
                                        <div className="md:pr-1.5 lg:pr-0">
                                            <Button
                                                ...
                                                <span className="hidden md:block">Request a Demo</span>
                                                <SendHorizonal
